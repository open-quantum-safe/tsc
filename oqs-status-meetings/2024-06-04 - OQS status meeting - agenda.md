# 2024-06-04 - OQS status meeting - agenda

<span style="color: red;"> Tuesday June 04 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://uwaterloo.zoom.us/j/98064335970?pwd=U0tTZk84blBZTnptTXh0YmlZd1dOQT09)

## Agenda

1. Security issues and advisory/release planning
1. Status updates

## 1. Security issues and advisory/release planning

- liboqs: [Control-flow timing leak in Kyber reference implementation when compiled with Clang 15-18 for -Os, -O1 and other options](https://github.com/pq-crystals/kyber/commit/9b8d30698a3e7449aeb34e62339d4176f11e3c6c)
- liboqs: [Fault injection attack on Dilithium (CVE-2024-31510)](https://www.cve.org/CVERecord?id=CVE-2024-31510)
- OQS provider: [Length decoding](https://github.com/open-quantum-safe/oqs-provider/commit/67ad18305605bf4f13b4a334cc3fe60c87d9309a)
...
0. **<span style="color: red;">Build failures:<span style="color: red;">**
	...
	- **<span style="color: red;">oqs-provider CircleCI<span style="color: red;">**
...
2. **liboqs**
	...
	- Open PRs:
		 ...
		 - PR 1805: Force gcc 13.2.0 over 13.3.0
	- Open Issues:
...
13. **liboqs-Java**
	...
	- Open PRs: None
	- Open Issues:
		 - Issue 25: Optimize pom.xml & Fix warning
		 - Issue 20: Tag 0.1.1
