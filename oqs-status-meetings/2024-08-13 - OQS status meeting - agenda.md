# 2024-08-13 - OQS status meeting - agenda

<span style="color: red;"> Tuesday August 13 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://uwaterloo.zoom.us/j/98064335970?pwd=U0tTZk84blBZTnptTXh0YmlZd1dOQT09)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 61: Remove kevinmkane per kevinmkane
		 - PR 63: Create new private liboqs-cupqc repository
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 - PR 1873: Don't hardcode OPENSSL\_ROOT\_DIR to /usr on Linux
		 - PR 1887: Fix overflow in stateful sigs tests
	- Open PRs:
	...
	- Open Issues:
		 ...
		 - Issue 1859: Multi-threaded performance testing issues
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 - PR 460: Remove external encoding lib
		 - PR 477: update coding style and test facilities
	- Open PRs:
	...
	- Open Issues:
		 ...
		 - Issue 467: Various warnings building OQS Provider on Mac
...
4. **OQS-BoringSSL**
	...
	- Merges in the last 7 days:
		 - PR 116: Update to upstream 369fe28
		 - PR 117: Fix CI & Add MAYO
	- Open PRs: None
	- Open Issues:
...
5. **OQS-OpenSSH**
	...
	- Open Issues:
		 ...
		 - Issue 161: Implement Hybrid SSH Keys
...
7. **oqs-demos**
	...
	- Merges in the last 7 days: None.
	- Open PRs:
		 - PR 291: Add nginx with QUIC Dockerfile
	- Open Issues:
