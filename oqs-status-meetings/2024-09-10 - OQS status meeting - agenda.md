# 2024-09-10 - OQS status meeting - agenda

<span style="color: red;"> Tuesday September 10 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://zoom-lfx.platform.linuxfoundation.org/meetings/pqca?view=month)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 72: Add agenda for 2024-09-03 OQS status meeting
		 - PR 75: Give oqs-bot access to liboqs-cpp and liboqs-go
		 - PR 73: Add meetings for Sept 3 and Aug 27 status calls
		 - PR 74: agenda draft
	- Open PRs: None
	- Open Issues:
...
2. **liboqs**
	...
	- Open PRs:
		 ...
		 - PR 1914: Kyber: avoid ASAN error on arm64
	- Open Issues:
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 - PR 510: add support for the CMAKE\_PARAMS environment variable
	- Open PRs:
		 - PR 367: improve static build testing
		 - PR 412: MSVC C2059 error when no signature is enabled
		 - PR 461: Add CROSS
		 - PR 511: update X25519-MLKEM768 code point
	- Open Issues:
...
4. **OQS-BoringSSL**
	...
	- Merges in the last 7 days:
		 - PR 121: Trigger CI on repository\_dispatch event
	- Open PRs: None
	- Open Issues:
