# 2024-11-05 - OQS status meeting - agenda

<span style="color: red;"> Tuesday November 05 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://zoom-lfx.platform.linuxfoundation.org/meetings/pqca?view=month)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 97: 20241029 minutes
	- Open PRs: None
	- Open Issues:
		 - Issue 96: Select new OQS rep to PQCA TAC
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 - PR 1959: Add new API to cleanup OpenSSL threads.
		 - PR 1955: Adapt existing sig fuzz harness including more algorithms
		 - PR 1971: add C++ linking test
		 - PR 1974: Make random/functions deterministic during fuzzing
		 - PR 1972: Remove SPHINCS+ aarch64 code
	- Open PRs:
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 559: update MLKEM code points
	- Open PRs:
		 ...
		 - PR 563: Remove macos-12 runner due to GitHub deprecation.
	- Open Issues:
...
7. **oqs-demos**
	...
	- Merges in the last 7 days:
		 - PR 310: Update README-Linux.md
		 - PR 309: Update README-Windows.md
		 - PR 311: Update oqs-Linux.patch
