# 2025-01-14 - OQS status meeting - agenda

<span style="color: red;"> Tuesday January 14 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://pqca.org/calendar/)
...
11. liboqs language wrappers: liboqs-C++, liboqs-.NET, liboqs-Go, liboqs-Java, liboqs-Python, liboqs-Rust## Pre-meeting project reviews
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 127: Add agenda and minutes for 2025-01-07 OQS status meeting
		 - PR 126: Remove jschanck from committers and codeowners
		 - PR 128: Add first draft of TSC agenda 2025-01-14
	- Open PRs:
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 - PR 2036: Bump jinja2 from 3.1.4 to 3.1.5 in /scripts/copy\_from\_upstream in the pip group
	- Open PRs:
...
6. **OQS-libssh**
	...
	- Merges in the last 7 days:
		 - PR 25: Update README prior to archiving
	- Open PRs: None
	- Open Issues: None
...
7. **oqs-demos**
	...
	- Merges in the last 7 days:
		 - PR 340: Updates for testserver to liboqs-0.12.0 & oqs-provider-0.8.0
	- Open PRs:
...
10. **www.openquantumsafe.org**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 243: Deprecate libssh
		 - PR 245: Update list of TSC members
		 - PR 244: Deprecate OQS-OpenSSL 1.1.1 and reorganize TLS page
	- Open PRs:
		 - PR 246: Bump \_includes/liboqs from `f4b9622` to `cc61cb0`
...
14. **liboqs-Java**
	...
	- Merges in the last 7 days:
		 - PR 31: Add support for the ML-DSA Context
	- Open PRs: None
	- Open Issues:
