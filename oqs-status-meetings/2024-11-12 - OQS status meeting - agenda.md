# 2024-11-12 - OQS status meeting - agenda

<span style="color: red;"> Tuesday November 12 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://zoom-lfx.platform.linuxfoundation.org/meetings/pqca?view=month)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 99: Update agenda for TSC meeting
		 - PR 102: VOTE: Add Spencer Wilson to OQS TSC and appoint as OQS rep to PQCA TAC
		 - PR 98: Add OQS status meeting agendas
		 - PR 104: Add 2024-11-05 OQS status meeting minutes
		 - PR 103: Add @SWilson4 to TSC team
	- Open PRs:
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 1983: imported fix from CROSS upstream: endianness-aware csprng
		 - PR 1987: chore: Add CI badges to README.md
	- Open PRs:
