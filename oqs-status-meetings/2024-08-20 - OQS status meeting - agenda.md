# 2024-08-20 - OQS status meeting - agenda

<span style="color: red;"> Tuesday August 20 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://zoom-lfx.platform.linuxfoundation.org/meetings/pqca?view=month)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 66: Add minutes from 2024-08-13 OQS status meeting
		 - PR 67: Give pi-314159 write access on oqs-demos
		 - PR 62: New teams
	- Open PRs: None
	- Open Issues:
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 - PR 480: Fix various warnings.
		 - PR 486: A note about key encapsulation/decapsulation support in OpenSSL
	- Open PRs:
...
4. **OQS-BoringSSL**
	...
	- Open PRs: None
	- Open Issues:
		 - Issue 118: Add support for hybrid signature algorithms
...
5. **OQS-OpenSSH**
	...
	- Merges in the last 7 days:
		 - PR 161: Implement Hybrid SSH Keys
	- Open PRs: None
	- Open Issues:
		 - Issue 166: Runtime of CircleCI jobs exceed the limit for the free tier
		 - Issue 165: Update PQ Algorithms
