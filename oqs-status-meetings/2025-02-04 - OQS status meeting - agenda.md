# 2025-02-04 - OQS status meeting - agenda

<span style="color: red;"> Tuesday February 04 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://pqca.org/calendar/)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 134: Minutes for 2025-01-28 OQS status meeting
	- Open PRs:
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 2058: CI: Check unresolved symbols when compiled with OQS\_DLOPEN\_OPENSSL
		 - PR 2059: Update sig\_stfl Doxygen documentation
		 - PR 2063: Fix failing zephyr CI workflows, pinning v0.27.4
	- Open PRs:
...
9. **www.openquantumsafe.org**
	...
	- Open PRs:
		 ...
		 - PR 252: Bump \_includes/liboqs from `f4b9622` to `f877812`
	- Open Issues:
...
14. **liboqs-Rust**
	...
	- Merges in the last 7 days:
		 - PR 276: chore: version bump to 0.10.1
