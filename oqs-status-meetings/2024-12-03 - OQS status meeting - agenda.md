# 2024-12-03 - OQS status meeting - agenda

<span style="color: red;"> Tuesday December 03 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://pqca.org/calendar/)

## Agenda

1. liboqs 0.12.0 release
2. Status updates
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 110: Add agenda for OQS status meeting 2024-11-26
	- Open PRs:
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 2006: Create liboqs 0.12.0 release candidate 1
	- Open PRs:
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 - PR 577: update IANA code points for ML-KEM
	- Open PRs:
...
7. **oqs-demos**
	...
	- Merges in the last 7 days:
		 - PR 326: Follow-up to PR #316: Fix Wireshark Dockerfile and update documentations
	- Open PRs:
