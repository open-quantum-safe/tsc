# 2025-03-04 - OQS status meeting - agenda

<span style="color: red;"> Tuesday March 04 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://pqca.org/calendar/)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 144: Add agenda for OQS status meeting 2025-02-25
		 - PR 145: Add minutes for 2025-02-25 status meeting
		 - PR 147: Add agenda for 2025-03-04 TSC meeting
	- Open PRs:
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 2093: Update actions/cache to v4.2.2
	- Open PRs:
	...
	- Open Issues:
		 - Issue 2091: Update MAYO version
...
3. **OQS-OpenSSL 3 provider**
	...
	- Open Issues:
		 - Issue 647: OpenSSL 3.3.0 with OQS Provider: Ml-DSA-87 Algorithms Not Supported Correctly
...
6. **oqs-demos**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 361: Updated oqs and provider version in readme
	- Open PRs: None
	- Open Issues:
...
9. **www.openquantumsafe.org**
	...
	- Merges in the last 7 days: None.
	- Open PRs:
		 - PR 259: Bump \_includes/liboqs from `f4b9622` to `38725ba`
	- Open Issues:
