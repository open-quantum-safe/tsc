# 2024-05-21 - OQS status meeting - agenda

<span style="color: red;"> Tuesday May 21 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://uwaterloo.zoom.us/j/98064335970?pwd=U0tTZk84blBZTnptTXh0YmlZd1dOQT09)
...
0. **<span style="color: red;">Build failures:<span style="color: red;">**
	...
	- **<span style="color: red;">liboqs-python Github Actions<span style="color: red;">**

1. **OQS Technical Steering Committee**


	- Merges in the last 7 days:
		 - PR 26: Add agendas and minutes from OQS weekly status meetings from 2024
	- Open PRs:
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 - PR 1793: Clean up unresolved comments on stateful-sigs PR
		 - PR 1790: Zeroing internal state memory on heap
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 - PR 414: update security issue reporting [skip ci]
	- Open PRs:
...
4. **OQS-BoringSSL**
	...
	- Merges in the last 7 days:
		 - PR 115: Update to upstream 783ae72
	- Open PRs: None
	- Open Issues:
...
13. **liboqs-Java**
	...
	- Merges in the last 7 days:
		 - PR 24: Remove NIST DRBG from API
	- Open PRs: None
	- Open Issues:
		 - Issue 20: Tag 0.1.1
