# 2024-06-25 - OQS status meeting - agenda

<span style="color: red;"> Tuesday June 25 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://uwaterloo.zoom.us/j/98064335970?pwd=U0tTZk84blBZTnptTXh0YmlZd1dOQT09)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 37: Add 2024-06-18 agenda
		 - PR 38: Add minutes from 2024-06-18 OQS status meeting.
		 - PR 39: Update OQS status meeting attendees
	- Open PRs:
...
3. **OQS-OpenSSL 3 provider**
	...
	- Open PRs:
		 ...
		 - PR 413: Add MAYO
	- Open Issues:
		 - Issue 438: Not able to decrypt certificate private key (generated using PQC algorithm)  
