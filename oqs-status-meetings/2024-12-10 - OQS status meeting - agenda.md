# 2024-12-10 - OQS status meeting - agenda

<span style="color: red;"> Tuesday December 10 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://pqca.org/calendar/)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 111: Add agenda for 2024-12-03 OQS status meeting
		 - PR 113: Create security-managers team
		 - PR 114: Add agenda for OQS TSC meeting 2024-12-10
		 - PR 115: Fix broken link
	- Open PRs:
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 - PR 583: Adding version-conditional context string support
	- Open PRs:
	...
	- Open Issues:
		 - Issue 579: key component order in hybrid keys
		 - Issue 578: Update ML-DSA to align with current IETF drafts
		 - Issue 575: OQS Provider Static Build Fails
		 - Issue 573: OpenSSL OQS unable to open mlddsa44 key from pkcs12 that is created with IAIK-PQ (Post-Quantum) library 
		 - Issue 572: content of hybrid public key
...
16. **www.openquantumsafe.org** : 

- Merges in the last 7 days: Website updates for 0.12.0 release
