# 2025-02-18 - OQS status meeting - agenda

<span style="color: red;"> Tuesday February 18 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://pqca.org/calendar/)
...
6. **oqs-demos**
	...
	- Open Issues:
		 - Issue 355: Unable to Connect to ML-DSA Endpoints in Chromium
...
9. **www.openquantumsafe.org**
	...
	- Merges in the last 7 days: None.
	- Open PRs:
		 - PR 256: Bump \_includes/liboqs from `f4b9622` to `5afca64`
	- Open Issues:
