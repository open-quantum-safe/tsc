# 2024-07-02 - OQS status meeting - agenda

<span style="color: red;"> Tuesday July 02 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://uwaterloo.zoom.us/j/98064335970?pwd=U0tTZk84blBZTnptTXh0YmlZd1dOQT09)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 42: Add to agenda list
		 - PR 41: Agenda for 2024-06-27 TSC meeting
		 - PR 43: Add OQS status meeting minutes 2024-06-25
		 - PR 44: Add notes from Trail of Bits meeting
	- Open PRs:
		 - PR 46: draft minutes
	- Open Issues:
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 - PR 441: Fix #439: install the static library under `$PREFIX/lib`.
		 - PR 442: Fix #440: disable tests and examples using `BUILD\_TESTING`.
	- Open PRs:
		 ...
		 - PR 413: Add MAYO
	- Open Issues:
		 - Issue 446: Interoperablity issue. - Unable to load Dilithium2 Public key in OpenSSL with OQSP Provider created by thirdparty CA
		 - Issue 443: Not able to read dilithium private key using PEM\_read\_bio\_PrivateKey routine 
...
5. **OQS-OpenSSH**
	...
	- Open PRs: None
	- Open Issues:
		 - Issue 159:  Upgrade to OpenSSH v9.7 
...
7. **oqs-demos**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 285: Update version references
	- Open PRs: None
	- Open Issues:
		 - Issue 286: Update OQS Demos Project
