# 2024-07-16 - OQS status meeting - agenda

<span style="color: red;"> Tuesday July 16 at 12:30 PM </span> US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://uwaterloo.zoom.us/j/98064335970?pwd=U0tTZk84blBZTnptTXh0YmlZd1dOQT09)
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 48: Update TSC, core access to WWW
		 - PR 50: Add minutes from 2024-07-02 OQS status meeting
		 - PR 51: Add agenda for 2024-07-09 OQS status meeting
		 - PR 52: Add minutes from 2024-07-09 OQS status meeting
	- Open PRs:
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 - PR 1832: Expose callback API for replacing low-level cryptographic primitives
...
5. **OQS-OpenSSH**
	...
	- Merges in the last 7 days:
		 - PR 159:  Upgrade to OpenSSH v9.7 
	- Open PRs: None
	- Open Issues:
		 - Issue 160: Apply upstream refactor to sshkey.c
