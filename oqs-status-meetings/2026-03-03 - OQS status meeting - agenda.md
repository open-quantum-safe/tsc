# 2026-03-03 - OQS status meeting - agenda

<span style="color: red;"> Tuesday March 03 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://pqca.org/calendar/)
...
1. **[OQS Technical Steering Committee](https://github.com/open-quantum-safe/tsc)**
	...
	- Merges in the last 7 days:
		 - [PR 252](https://github.com/open-quantum-safe/tsc/pull/252): Refactor agenda script, add liboqs-js
		 - [PR 251](https://github.com/open-quantum-safe/tsc/pull/251): Add meeting summary from OQS status meeting - 2026-02-24
		 - [PR 250](https://github.com/open-quantum-safe/tsc/pull/250): Agenda script: determine next meeting time from PQCA ical
		 - [PR 249](https://github.com/open-quantum-safe/tsc/pull/249): Add agenda for OQS status meeting 2026-02-24 and agenda generation script
	- Open PRs:
...
8. **[www.openquantumsafe.org](https://github.com/open-quantum-safe/www)**
	...
	- Open PRs:
		 - [PR 314](https://github.com/open-quantum-safe/www/pull/314): Bump \_includes/liboqs from `6b390dd` to `d1d8447`  `dependencies` `submodules`
