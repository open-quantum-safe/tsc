# 2024-11-26 - OQS status meeting - agenda

<span style="color: red;"> Tuesday November 26 at 10:00 AM </span> US Eastern Time / 4:00 PM Central European / 7:00 AM US Pacific Time on Zoom (https://pqca.org/calendar/)

## Agenda

1. liboqs 0.12.0 release planning
2. Status updates
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 107: Add agenda for 2024-11-19 OQS status meeting
		 - PR 108: Updating info on recurring TSC meetings
		 - PR 109: Add 2024-11-19 minutes
...
2. **liboqs**
	...
	- Open PRs:
		 ...
		 - PR 1997: Set ML-KEM alg\_version to "FIPS203"
		 - PR 2000: Add defines for OQS version components
	- Open Issues:
		 - Issue 2004: Credit HQC bug reporters in 0.12.0 release notes
		 - Issue 2001: Deprecate signature API without context string?
		 - Issue 1999: Strengthen signature verification failure tests 
		 - Issue 1996: Update ML-KEM alg\_version to "FIPS203"
...
3. **OQS-OpenSSL 3 provider**
	...
	- Open Issues:
		 - Issue 576: Compile error in latest (commit 527e41) 
...
4. **OQS-BoringSSL**
	...
	- Open PRs: None
	- Open Issues:
		 - Issue 127: Is it compatible with Chrome browser?
...
7. **oqs-demos**
	...
	- Merges in the last 7 days:
		 ...
		 - PR 322: correct dockerhub secrets location
		 - PR 317: Implement GitHub Actions workflow for scanning Docker images (Ref: #301)
		 - PR 323: further fixup to #298
		 - PR 320: Move deprecated demos into deprecated subdirectory
		 - PR 319: Address CircleCI failures
		 - PR 316: Update Wireshark Demo
	- Open PRs:
		 - PR 321: Move CI to GitHub Actions
	- Open Issues:
		 - Issue 324: Wireshark docker scan failing
