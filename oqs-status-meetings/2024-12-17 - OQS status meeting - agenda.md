# 2024-12-17 - OQS status meeting - agenda

Tuesday December 17 at 12:30 PM US Eastern Time / 6:30 PM Central European / 9:30 AM US Pacific Time on Zoom (https://pqca.org/calendar/)

<span style="color: red;">Note: this is the last OQS  status meeting of 2024. No meetings on December 24 or 31. We resume on Tuesday January 7 at 10 AM US Eastern.</span>
...
1. **OQS Technical Steering Committee**
	...
	- Merges in the last 7 days:
		 - PR 116: Add agenda for 2024-12-10 OQS status meeting
		 - PR 117: Additional item for TSC agenda
		 - PR 118: Additional agenda item
		 - PR 119: Minutes for 2024-12-10 status meeting
	- Open PRs:
...
2. **liboqs**
	...
	- Merges in the last 7 days:
		 - PR 2007: Minor changes to ML\_DSA ACVP tests
		 - PR 2011: 0.12.0 release
		 - PR 2015: Bump version to 0.12.1-dev
		 - PR 2010: Add loongarch64 support
		 - PR 2017: Update upload-artifact action to v4
		 - PR 2019: Remove hardcoded build paths & modify basic workflow to build in random path
	- Open PRs:
		 ...
		 - PR 2021: Trigger liboqs-java and liboqs-rust downstream CI
	- Open Issues:
...
3. **OQS-OpenSSL 3 provider**
	...
	- Merges in the last 7 days:
		 - PR 585: Add a SBOM template in CycloneDX format
		 - PR 584: Changes needed when building with a static libcrypto on Linux
		 - PR 568: Tracker for FIPS204 / ML-DSA
		 - PR 586: Add DTLS 1.3 support
	- Open PRs:
		 ...
		 - PR 593: 0.8.0 rc1 branch
	- Open Issues:
		 - Issue 594: output debug messages to standard error stream
		 - Issue 590: Add static build CI
		 - Issue 573: OpenSSL OQS unable to open mlddsa44 key from pkcs12 that is created with IAIK-PQ (Post-Quantum) library 
...
4. **OQS-BoringSSL**
	...
	- Open PRs: None
	- Open Issues:
		 - Issue 128: Update for liboqs 0.12.0 release?
...
7. **oqs-demos**
	...
	- Merges in the last 7 days:
		 - PR 325: Address docker build warnings
	- Open PRs:
		 - PR 321: Move CI to GitHub Actions
		 - PR 327: [Draft] Refactor Dockerfiles for Best Practices and Optimization
		 - PR 329: Add GitHub Actions workflow to lint Dockerfiles
	- Open Issues:
...
11. **liboqs-.NET**
	...
	- Open PRs: None
	- Open Issues:
		 - Issue 31: Add API for signatures with context string
...
13. **liboqs-Java**
	...
	- Open PRs: None
	- Open Issues:
		 - Issue 30: Move CI to GitHub Actions
...
15. **liboqs-Rust**
	...
	- Open PRs:
		 ...
		 - PR 271: ci: Fix OpenSSL path, add repository\_dispatch trigger
	- Open Issues:
		 - Issue 270: Add APi for signatures with context string
